      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
              ...
              <?php
               if(isset($_SESSION["customer"]) || isset($_SESSION["manager"])){
                 echo ' <li><a href="logout.php"><span class="	glyphicon glyphicon-log-out"></span>&nbsp; LogOut </a></li>'.'<li><a href="#"><span class="glyphicon glyphicon-user"></span>&nbsp;'
